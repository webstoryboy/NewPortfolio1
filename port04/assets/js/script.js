...
new TimelineMax({onStart:populate})
    ...
    .set('.btn1',      {width:90, height:90, borderRadius:'50%', border:'0.2vw solid transparent', textAlign:'center', fontSize:72, lineHeight:'102px', cursor:'pointer'})
    .set(hintBtn,     {right:50, bottom:90, width:100, fontSize:25, textAlign:'center', cursor:'pointer', autoAlpha:0, borderRadius: '50%', backgroundColor: '#788ba7', color: '#e6e0d8', padding: '1vw'})
    .set('.foundTxt', {left:50, top:30, width:1024, fontSize:35, textAlign:'center', textContent:'Find the Same Emoji!', fontWeight:300, letterSpacing:0.25})
    .set('.timeTxt',  {left:30, top:20, fontSize:50, borderRadius: '1.5vw', backgroundColor: 'rgba(120, 139, 167, 0.77)', padding: '0.5vw 1vw', color: '#e6e0d8'})
    .set('.timePlus', {left:200, top:20, fontSize:25, alpha:0})
    .set('.end',      {width:'100%', height:'100%', autoAlpha:0})
    .set('.endTxt',   {textAlign:'center', left: 40, top:257, width:1024, fontSize:25, fontWeight:300})
    .set(replayBtn,   {left:430, top:275, scale:0.6, transformOrigin:'120px 130px', cursor:'pointer'})
...
function populate() {
    ...
    TweenMax.staggerFromTo('.btn1', 0.3, {scale:0.2, alpha:0, rotation:1}, {rotation:0, alpha:1, scale:1, ease:Back.easeOut.config(4), stagger:{ grid:[4,4], from:"center", amount:0.2} });
    ...
    if (lastBtn!=undefined && lastBtn!=b) {
        if (b.textContent==lastBtn.textContent) { //matched
            ...
            new TimelineMax({onComplete:populate})
                ...
                .to('.btn1',           0.1, {border:'0.2vw solid transparent'}, 0.5)
            return;
        }
        //not matched
        else TweenMax.to(lastBtn, 0.1, {border:'0.2vw solid transparent'});
    }
    TweenMax.to(b, 0.1, {border:'0.2vw solid #006da6'});
...
function updateTime(){
    if (timeLeft>0){
        ...
        timeInt = undefined;
        if (found==0) TweenMax.set('.foundTxt', {textContent:'Found: 0', fontWeight:500, color: '#e6e0d8'});
        ...
        new TimelineMax()
            ...
            .to('.btn1',       0.1, {border:'0.2vw solid transparent'}, 0.3)
...
function doResize() {
    ...
    new TimelineMax()
        .set('#b1',  {left:360, top:120})
        .set('#b2',  {left:460, top:120})
        .set('#b3',  {left:560, top:120})
        .set('#b4',  {left:660, top:120})
        .set('#b5',  {left:360, top:220})
        .set('#b6',  {left:460, top:220})
        .set('#b7',  {left:560, top:220})
        .set('#b8',  {left:660, top:220})
        .set('#b9',  {left:360, top:320})
        .set('#b10', {left:460, top:320})
        .set('#b11', {left:560, top:320})
        .set('#b12', {left:660, top:320})
        .set('#b13', {left:360, top:420})
        .set('#b14', {left:460, top:420})
        .set('#b15', {left:560, top:420})
        .set('#b16', {left:660, top:420})
}
doResize();
