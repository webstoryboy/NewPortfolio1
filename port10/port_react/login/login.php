...
<head>
    ...
    <title>YOON REACT PORT - LOGIN</title>
</head>
<body>
	...
	<header id="header">
	 ...
	 <!-- <div class="about_logo">
		  <img src="../assets/img/about_icon.png" alt="내 아이콘">
	 </div> -->
	  <div class="member">
			<ul>
				 <li><a href="#" class="page__click">Board</a></li>
				 <li><a href="#" class="page__click">Login</a></li>
			</ul>
	  </div>
	</header>
	<!--//header-->
